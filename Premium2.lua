...
if script_id then
    ...
    if premium and script_id ~= "65c66a87b33565a9dea1a54b798b6b2a" then
    ...
    if not premium then script_key = "TePzKWviutPzyNmGRKrtGlczDljLJrMM" or nil; premium = true; is_premium = true end
